...
const MobileMenuButton = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`md:hidden text-white p-2 hover:bg-white/10 rounded-lg transition-[transform,color,background-color] duration-200 active:scale-95 cursor-pointer ${className}`}
